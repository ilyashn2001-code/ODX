...
function renderPriorityRule(rule) {
  ...
  function finalizeRun() {
    ...
    $('parametersCard')?.classList.add('hidden');
    $('reviewCard')?.classList.add('hidden');
    document.querySelector('.stepper-card')?.classList.add('hidden');
...
function renderResultsTable() {
  ...
  function resetAll() {
    ...
    $('loadingSection').classList.add('hidden');
    document.querySelector('.stepper-card')?.classList.remove('hidden');
    const launchCard = $('launchCard');
    if (launchCard) launchCard.classList.remove('hidden');
    resetState();
    renderStepper();
    renderToolOptions();
    renderDatasetPickers();
